...
public class RecyclerViewOnScroll extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            // since may lead to the final item has more than one StaggeredGridLayoutManager the particularity
            // of the so here that is an array this array into an array of position and then take the
